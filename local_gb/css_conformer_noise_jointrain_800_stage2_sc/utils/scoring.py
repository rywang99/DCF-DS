...
import sys
#sys.path.append('/yrfs5/sre/sqqian/speaker_sep/chime8/NOTSOFAR1-Challenge/meeteval')
import meeteval
...
def calc_wer(out_dir: str, tcp_wer_hyp_stm: str, tcorc_wer_hyp_stm: str,session_id: str,
    ...
    def calc_session_tcp_wer(session: pd.Series):
        ...
        #         reference=session.ref_stm, hypothesis=session.tcp_wer_hyp_stm, collar=collar
        #     )
